export default () => 
    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-2 leading-8 text-3xl font-extrabold tracking-tight text-gray-900">
            Δημιούργησε lead σε δευτερόλεπτα
        </h2>
        <p className="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
            Με άμεση αναζήτηση σε πλατφόρμες όπως ο χρυσός οδηγός και το taxis, έχεις πρόσβαση σε εταιρικά προφίλ από όλη την Ελλάδα
        </p>
        </div>
